        ...
        <a class="nav-link" href="contact-us.php">Contact</a>
                ...
                <div class="col-md-3">
                    <div class="top-login-btn">
                        <button type="button" onclick="location.href='login-patient.php';">Log In</button>
                        <button class="ragis" type="button" onclick="location.href='signup-patient.php';">Register</button>
                    </div>
                </div> 
            </div>
        </div>
